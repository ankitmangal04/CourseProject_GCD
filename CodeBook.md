...
The script run_analysis.R writes a dataset, tidy.txt is the result of an aggregation of tidydata which is cleaned and processed form of original data set.
